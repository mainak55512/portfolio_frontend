...
<div>
	...
	<div class="flex flex-col items-center">
		...
		<h1 class="mt-5 text-center text-5xl font-black text-white/70">Hi👋, I am Mainak!</h1>
	...
	<div class="grid grid-cols-4 gap-4">
		{#each entities as entity}
			...
			>
				...
				<img alt="placeholder" src="/resource/placeholder.jpg" class="h-40 w-90 rounded-lg" />
			</button>
		{/each}
	</div>
	...
	<div class="flex justify-center">
		<div class="flex flex-row">
			<img alt="placeholder" src="/resource/github.png" class="m-2 h-8 w-8 rounded-lg" />
			<img alt="placeholder" src="/resource/linkedin.png" class="m-2 h-8 w-8 rounded-lg" />
		</div>
	</div>
	<div class="flex flex-col justify-center">
